...
class GroqLLMService:
    ...
    def complete_json(
        ...
        *,
        ...
        estimated = self.estimate_request_tokens(user_prompt) if system_prompt == CATEGORIZATION_SYSTEM_PROMPT else estimate_tokens(system_prompt, user_prompt) + 40
...
def generate_narrative_insights(
    ...
    raw = service.complete_json(NARRATIVE_SYSTEM_PROMPT, user_prompt)
